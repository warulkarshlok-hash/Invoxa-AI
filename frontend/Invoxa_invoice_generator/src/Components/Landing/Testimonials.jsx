      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {TESTIMONIALS.map((testimonial, index) => (
            <div
              key={index}
              className="relative bg-gray-50 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-200"
            >
              ...
              <p className="text-gray-700 mb-6 leading-relaxed italic text-lg mt-10">
                {testimonial.quote}
              </p>
