import { BarChart2, Mail, Sparkles, FileText } from "lucide-react";
...
export const TESTIMONIALS = [
  {
    ...
    author: "Santosh Warulkar",
    title: "Small Business Owner",
    avatar: "https://placehold.co/100x100/000000/ffffff?text=SW",
  },
  {
    quote:
      "The best invoicing app I have ever used. Simple, intuitive, and powerful.",
    author: "Rahul Warulkar",
    title: "Small Business Owner",
    avatar: "https://placehold.co/100x100/000000/ffffff?text=RW",
  },
  {
    quote:
      "I love the dashboard and reporting features. It helps me keep track of my finances.",
    author: "Uday Panjwani",
    title: "Grocery Owner",
    avatar: "https://placehold.co/100x100/000000/ffffff?text=PP",
  },
];
...
export const FAQS = [
  {
    ...
    answer:
      "Simply paste any text that contains invoice details—like an email, a list of items, or a work summary-and our AI will instantly parse it to pre-fill a new invoice for you,saving your time and effort ",
  },
  {
    question: "Is there a free trial available?",
    answer:
      "Yes, you can try our platform for free for 14 days. If you want, we'll provide you with a free ,personalized 30-minute onboarding call to get you up and running as soon as possible",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Plans are per workspace, not per account. You can upgrade one workspace, and many more...",
  },
];
